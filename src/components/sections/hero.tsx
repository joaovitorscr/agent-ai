...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden">
      <div className="absolute -top-24 left-1/2 h-[500px] w-[800px] -translate-x-1/2 bg-primary/30 opacity-20 blur-[100px]" />

      <div className="relative mx-auto flex w-full flex-col items-center justify-center space-y-10 px-6 py-12 text-center lg:px-8 lg:py-24">
